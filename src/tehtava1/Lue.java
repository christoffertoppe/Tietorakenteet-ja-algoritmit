...
public class Lue {
	 ...
	 * 
	 * Operaatiot: Lue.rivi() antaa seuraavan syöttörivin (String) Lue.kluku() " "
	 * kokonaisluvun (int) Lue.dluku() " " desimaaliluvun (double) Lue.merkki()
	 * antaa seuraavan syöttörivin ensimmäisen merkin
	 * 
